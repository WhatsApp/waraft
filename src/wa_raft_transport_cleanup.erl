...
%% Get the default name for the RAFT transport cleanup server associated with the
...
%% Get the registered name for the RAFT transport cleanup server associated with the
